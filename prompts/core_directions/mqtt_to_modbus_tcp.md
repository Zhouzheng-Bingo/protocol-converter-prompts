...
[L_arch] ----------------------------------------------------------------
Conversion direction: MQTT -> Modbus TCP
...
IMPORTANT: this is a UNIDIRECTIONAL converter (MQTT -> Modbus TCP).
  - read only from MQTT;
  - write only to Modbus TCP;
  - do NOT subscribe to or poll Modbus TCP as a source;
...
Required structure of the generated Python script:
  ...
  2. Server config: MQTT at localhost:1883; Modbus TCP at localhost:502.
