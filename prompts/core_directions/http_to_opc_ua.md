...
[L_arch] ----------------------------------------------------------------
Conversion direction: HTTP -> OPC UA
...
IMPORTANT: this is a UNIDIRECTIONAL converter (HTTP -> OPC UA).
  - read only from HTTP;
...
Required structure of the generated Python script:
  ...
  2. Server config: HTTP at localhost:8080; OPC UA at localhost:4840.
